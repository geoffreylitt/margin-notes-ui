...
`,
    ...
    meta: {
      filename: "/Users/glitt/personal-dev/example_recorder/lib/example_recorder.rb",
      code:`
...
module ExampleRecorder
  class Recorder
    def initialize(path:, max_examples_per_method: 10, example_classes: nil)
      @examples = []
    ...
    def serialized_examples(limit: 200)
    ...
    attr_accessor :path, :max_examples_per_method, :example_classes
    ...
    def trace
      TracePoint.new(:call, :return) do |tp|
        begin
          ...
          # show self as the implicit first argument
          params_with_values =
            { self: tp.binding.receiver }.merge(params_with_values)
          ...
          if tp.event == :call
            if !example_classes.nil?
              next unless example_classes.include? tp.defined_class
            end
            ...
            unless in_progress_example.nil?
              ...
              duplicate_example = @seen_examples_set.include?(unique_example_key)
              next if duplicate_example

              # commented out:
              # this was an attempt to limit the number of examples per method,
              # but ran into some weird bugs.
              # n_examples_for_method =
              #   @seen_examples_set.
              #   select { |example| example[:method] == in_progress_example[:method] }.
              #   size
              # puts "seen #{n_examples_for_method} examples of #{in_progress_example[:method]}"
              # next if duplicate_example || (n_examples_for_method >= max_examples_per_method)
    ...
    PRIMITIVE_TYPES = [Hash, Array, String, Numeric, TrueClass, FalseClass, NilClass]
    ...
    def serialize_value(value)
      PRIMITIVE_TYPES.each do |primitive_type|
        return value if value.is_a? primitive_type
      end

      # show symbols as strings
...
`,
      data: [{"klass":"ExampleRecorder::Recorder","method":"#<Method: ExampleRecorder::Recorder#record>","parameters":[],"arguments":{"self":{"class_name":"ExampleRecorder::Recorder","value":{"@examples":[{"klass":"Game","method":"#<Method: Game#won_row?>","parameters":[["req","player"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","player":0},"return_value":{"class_name":"FalseClass","value":false}},{"klass":"Game","method":"#<Method: Game#won_column?>","parameters":[["req","player"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","player":0},"return_value":{"class_name":"FalseClass","value":false}},{"klass":"Game","method":"#<Method: Game#won_diagonal?>","parameters":[["req","player"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","player":0},"return_value":{"class_name":"FalseClass","value":false}},{"klass":"Game","method":"#<Method: Game#won?>","parameters":[["req","player"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","player":0},"return_value":{"class_name":"FalseClass","value":false}},{"klass":"Game","method":"#<Method: Game#won_row?>","parameters":[["req","player"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","player":1},"return_value":{"class_name":"FalseClass","value":false}},{"klass":"Game","method":"#<Method: Game#won_column?>","parameters":[["req","player"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","player":1},"return_value":{"class_name":"FalseClass","value":false}},{"klass":"Game","method":"#<Method: Game#won_diagonal?>","parameters":[["req","player"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","player":1},"return_value":{"class_name":"FalseClass","value":false}},{"klass":"Game","method":"#<Method: Game#won?>","parameters":[["req","player"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","player":1},"return_value":{"class_name":"FalseClass","value":false}},{"klass":"Game","method":"#<Method: Game#winner>","parameters":[],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X "},"return_value":{"class_name":"NilClass","value":null}},{"klass":"Game","method":"#<Method: Game#validate_move!>","parameters":[["req","row"],["req","col"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","row":0,"col":0},"return_value":{"class_name":"NilClass","value":null}},{"klass":"Game","method":"#<Method: Game#toggle_active_player!>","parameters":[],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X "},"return_value":{"class_name":"Integer","value":1}},{"klass":"Game","method":"#<Method: Game#move>","parameters":[["req","row"],["req","col"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","row":0,"col":0},"return_value":{"class_name":"Integer","value":1}},{"klass":"Game","method":"#<Method: Game#to_s>","parameters":[],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X "},"return_value":{"class_name":"String","value":" X |   |   \n------------\n   |   |   \n------------\n   |   |   "}},{"klass":"AIPlayer","method":"#<Method: AIPlayer#random_candidates>","parameters":[["req","game"]],"arguments":{"self":"#<AIPlayer:0x00007fc8e81781b8>","game":" X |   | O \n------------\n O | X |   \n------------\n   |   | X "},"return_value":{"class_name":"Array","value":[[0,1],[0,2],[1,0],[1,1],[1,2],[2,0],[2,1],[2,2]]}},{"klass":"AIPlayer","method":"#<Method: AIPlayer#get_move>","parameters":[["req","game"]],"arguments":{"self":"#<AIPlayer:0x00007fc8e81781b8>","game":" X |   | O \n------------\n O | X |   \n------------\n   |   | X "},"return_value":{"class_name":"Array","value":[0,2]}},{"klass":"Game","method":"#<Method: Game#validate_move!>","parameters":[["req","row"],["req","col"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","row":0,"col":2},"return_value":{"class_name":"NilClass","value":null}},{"klass":"Game","method":"#<Method: Game#toggle_active_player!>","parameters":[],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X "},"return_value":{"class_name":"Integer","value":0}},{"klass":"Game","method":"#<Method: Game#move>","parameters":[["req","row"],["req","col"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","row":0,"col":2},"return_value":{"class_name":"Integer","value":0}},{"klass":"Game","method":"#<Method: Game#to_s>","parameters":[],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X "},"return_value":{"class_name":"String","value":" X |   | O \n------------\n   |   |   \n------------\n   |   |   "}},{"klass":"Game","method":"#<Method: Game#validate_move!>","parameters":[["req","row"],["req","col"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","row":1,"col":1},"return_value":{"class_name":"NilClass","value":null}},{"klass":"Game","method":"#<Method: Game#move>","parameters":[["req","row"],["req","col"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","row":1,"col":1},"return_value":{"class_name":"Integer","value":1}},{"klass":"Game","method":"#<Method: Game#to_s>","parameters":[],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X "},"return_value":{"class_name":"String","value":" X |   | O \n------------\n   | X |   \n------------\n   |   |   "}},{"klass":"AIPlayer","method":"#<Method: AIPlayer#random_candidates>","parameters":[["req","game"]],"arguments":{"self":"#<AIPlayer:0x00007fc8e81781b8>","game":" X |   | O \n------------\n O | X |   \n------------\n   |   | X "},"return_value":{"class_name":"Array","value":[[0,1],[1,0],[1,2],[2,0],[2,1],[2,2]]}},{"klass":"AIPlayer","method":"#<Method: AIPlayer#get_move>","parameters":[["req","game"]],"arguments":{"self":"#<AIPlayer:0x00007fc8e81781b8>","game":" X |   | O \n------------\n O | X |   \n------------\n   |   | X "},"return_value":{"class_name":"Array","value":[1,0]}},{"klass":"Game","method":"#<Method: Game#validate_move!>","parameters":[["req","row"],["req","col"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","row":1,"col":0},"return_value":{"class_name":"NilClass","value":null}},{"klass":"Game","method":"#<Method: Game#move>","parameters":[["req","row"],["req","col"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","row":1,"col":0},"return_value":{"class_name":"Integer","value":0}},{"klass":"Game","method":"#<Method: Game#to_s>","parameters":[],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X "},"return_value":{"class_name":"String","value":" X |   | O \n------------\n O | X |   \n------------\n   |   |   "}},{"klass":"Game","method":"#<Method: Game#validate_move!>","parameters":[["req","row"],["req","col"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","row":2,"col":2},"return_value":{"class_name":"NilClass","value":null}},{"klass":"Game","method":"#<Method: Game#move>","parameters":[["req","row"],["req","col"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","row":2,"col":2},"return_value":{"class_name":"Integer","value":1}},{"klass":"Game","method":"#<Method: Game#to_s>","parameters":[],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X "},"return_value":{"class_name":"String","value":" X |   | O \n------------\n O | X |   \n------------\n   |   | X "}},{"klass":"Game","method":"#<Method: Game#won_diagonal?>","parameters":[["req","player"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","player":0},"return_value":{"class_name":"TrueClass","value":true}},{"klass":"Game","method":"#<Method: Game#won?>","parameters":[["req","player"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","player":0},"return_value":{"class_name":"TrueClass","value":true}},{"klass":"Game","method":"#<Method: Game#winner>","parameters":[],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X "},"return_value":{"class_name":"Integer","value":0}}],"@in_progress_examples":{"[Game, :winner, 9]":{"klass":"Game","method":"#<Method: Game#winner>","parameters":[],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X "},"return_value":{"class_name":"NilClass","value":null}},"[Game, :won?, 12]":{"klass":"Game","method":"#<Method: Game#won?>","parameters":[["req","player"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","player":1},"return_value":{"class_name":"FalseClass","value":false}},"[Game, :won_row?, 13]":{"klass":"Game","method":"#<Method: Game#won_row?>","parameters":[["req","player"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","player":1},"return_value":{"class_name":"FalseClass","value":false}},"[Game, :won_column?, 13]":{"klass":"Game","method":"#<Method: Game#won_column?>","parameters":[["req","player"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","player":1},"return_value":{"class_name":"FalseClass","value":false}},"[Game, :won_diagonal?, 13]":{"klass":"Game","method":"#<Method: Game#won_diagonal?>","parameters":[["req","player"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","player":1},"return_value":{"class_name":"FalseClass","value":false}},"[Game, :won_row?, 11]":{"klass":"Game","method":"#<Method: Game#won_row?>","parameters":[["req","player"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","player":0},"return_value":{"class_name":"FalseClass","value":false}},"[Game, :won_column?, 11]":{"klass":"Game","method":"#<Method: Game#won_column?>","parameters":[["req","player"]],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X ","player":0},"return_value":{"class_name":"FalseClass","value":false}},"[Game, :toggle_active_player!, 8]":{"klass":"Game","method":"#<Method: Game#toggle_active_player!>","parameters":[],"arguments":{"self":" X |   | O \n------------\n O | X |   \n------------\n   |   | X "},"return_value":{"class_name":"Integer","value":1}}},"@path":"/Users/glitt/personal-dev","@max_examples_per_method":10,"@example_classes":null,"@trace":"#<TracePoint:0x00007fc8e90d3428>","@seen_examples_set":"#<Set: {{:method=>#<Method: Game#won_row?>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :player=>0}, :return_value=>{:class_name=>\"FalseClass\", :value=>false}}, {:method=>#<Method: Game#won_column?>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :player=>0}, :return_value=>{:class_name=>\"FalseClass\", :value=>false}}, {:method=>#<Method: Game#won_diagonal?>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :player=>0}, :return_value=>{:class_name=>\"FalseClass\", :value=>false}}, {:method=>#<Method: Game#won?>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :player=>0}, :return_value=>{:class_name=>\"FalseClass\", :value=>false}}, {:method=>#<Method: Game#won_row?>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :player=>1}, :return_value=>{:class_name=>\"FalseClass\", :value=>false}}, {:method=>#<Method: Game#won_column?>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :player=>1}, :return_value=>{:class_name=>\"FalseClass\", :value=>false}}, {:method=>#<Method: Game#won_diagonal?>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :player=>1}, :return_value=>{:class_name=>\"FalseClass\", :value=>false}}, {:method=>#<Method: Game#won?>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :player=>1}, :return_value=>{:class_name=>\"FalseClass\", :value=>false}}, {:method=>#<Method: Game#winner>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>}, :return_value=>{:class_name=>\"NilClass\", :value=>nil}}, {:method=>#<Method: Game#validate_move!>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :row=>0, :col=>0}, :return_value=>{:class_name=>\"NilClass\", :value=>nil}}, {:method=>#<Method: Game#toggle_active_player!>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>}, :return_value=>{:class_name=>\"Integer\", :value=>1}}, {:method=>#<Method: Game#move>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :row=>0, :col=>0}, :return_value=>{:class_name=>\"Integer\", :value=>1}}, {:method=>#<Method: Game#to_s>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>}, :return_value=>{:class_name=>\"String\", :value=>\" X |   |   \\n------------\\n   |   |   \\n------------\\n   |   |   \"}}, {:method=>#<Method: AIPlayer#random_candidates>, :arguments=>{:self=>#<AIPlayer:0x00007fc8e81781b8>, :game=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>}, :return_value=>{:class_name=>\"Array\", :value=>[[0, 1], [0, 2], [1, 0], [1, 1], [1, 2], [2, 0], [2, 1], [2, 2]]}}, {:method=>#<Method: AIPlayer#get_move>, :arguments=>{:self=>#<AIPlayer:0x00007fc8e81781b8>, :game=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>}, :return_value=>{:class_name=>\"Array\", :value=>[0, 2]}}, {:method=>#<Method: Game#validate_move!>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :row=>0, :col=>2}, :return_value=>{:class_name=>\"NilClass\", :value=>nil}}, {:method=>#<Method: Game#toggle_active_player!>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>}, :return_value=>{:class_name=>\"Integer\", :value=>0}}, {:method=>#<Method: Game#move>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :row=>0, :col=>2}, :return_value=>{:class_name=>\"Integer\", :value=>0}}, {:method=>#<Method: Game#to_s>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>}, :return_value=>{:class_name=>\"String\", :value=>\" X |   | O \\n------------\\n   |   |   \\n------------\\n   |   |   \"}}, {:method=>#<Method: Game#validate_move!>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :row=>1, :col=>1}, :return_value=>{:class_name=>\"NilClass\", :value=>nil}}, {:method=>#<Method: Game#move>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :row=>1, :col=>1}, :return_value=>{:class_name=>\"Integer\", :value=>1}}, {:method=>#<Method: Game#to_s>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>}, :return_value=>{:class_name=>\"String\", :value=>\" X |   | O \\n------------\\n   | X |   \\n------------\\n   |   |   \"}}, {:method=>#<Method: AIPlayer#random_candidates>, :arguments=>{:self=>#<AIPlayer:0x00007fc8e81781b8>, :game=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>}, :return_value=>{:class_name=>\"Array\", :value=>[[0, 1], [1, 0], [1, 2], [2, 0], [2, 1], [2, 2]]}}, {:method=>#<Method: AIPlayer#get_move>, :arguments=>{:self=>#<AIPlayer:0x00007fc8e81781b8>, :game=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>}, :return_value=>{:class_name=>\"Array\", :value=>[1, 0]}}, {:method=>#<Method: Game#validate_move!>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :row=>1, :col=>0}, :return_value=>{:class_name=>\"NilClass\", :value=>nil}}, {:method=>#<Method: Game#move>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :row=>1, :col=>0}, :return_value=>{:class_name=>\"Integer\", :value=>0}}, {:method=>#<Method: Game#to_s>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>}, :return_value=>{:class_name=>\"String\", :value=>\" X |   | O \\n------------\\n O | X |   \\n------------\\n   |   |   \"}}, {:method=>#<Method: Game#validate_move!>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :row=>2, :col=>2}, :return_value=>{:class_name=>\"NilClass\", :value=>nil}}, {:method=>#<Method: Game#move>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :row=>2, :col=>2}, :return_value=>{:class_name=>\"Integer\", :value=>1}}, {:method=>#<Method: Game#to_s>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>}, :return_value=>{:class_name=>\"String\", :value=>\" X |   | O \\n------------\\n O | X |   \\n------------\\n   |   | X \"}}, {:method=>#<Method: Game#won_diagonal?>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :player=>0}, :return_value=>{:class_name=>\"TrueClass\", :value=>true}}, {:method=>#<Method: Game#won?>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>, :player=>0}, :return_value=>{:class_name=>\"TrueClass\", :value=>true}}, {:method=>#<Method: Game#winner>, :arguments=>{:self=>#<Game:0x00007fc8e8178398 @squares=[[\"X\", nil, \"O\"], [\"O\", \"X\", nil], [nil, nil, \"X\"]], @active_player=1>}, :return_value=>{:class_name=>\"Integer\", :value=>0}}}>"}}},"return_value":{"class_name":"TrueClass","value":true},"class_name":"ExampleRecorder::Recorder","method_name":"record","method_location":["/Users/glitt/personal-dev/example_recorder/lib/example_recorder.rb",58]}]
    }
  }